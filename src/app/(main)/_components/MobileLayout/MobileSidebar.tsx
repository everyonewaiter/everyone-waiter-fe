...
export default function MobileSidebar({ onClose }: IProps) {
  ...
  return (
    <div className="bg-opacity-100 fixed inset-0 z-[9998] flex bg-black/50 backdrop-blur-sm md:hidden">
      <aside
        ref={ref}
        className="relative flex h-dvh w-[284px] flex-col overflow-auto rounded-tr-[10px] rounded-br-[10px] bg-white stroke-gray-600 px-4"
      >
