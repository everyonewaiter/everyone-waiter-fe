...
export default function PageTitle({ title }: { title: string }) {
  ...
  return (
    <div className="z-50 flex h-[51px] w-full items-center justify-between border-b border-gray-600 bg-white pt-6 pb-3 md:h-12 md:pt-5 md:pb-2 lg:h-[100px] lg:pt-8 lg:pb-5">
