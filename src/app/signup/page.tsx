...
export default function Signup() {
  ...
  return (
    <>
      ...
      />
      <form
        className="flex gap-4 not-only:flex-col md:mt-10 md:w-[292px] lg:mt-12 lg:w-[432px]"
      ...
      >
        <div className="flex w-full flex-col gap-1">
          ...
          <input
            ...
            className="md:text-s flex grow-1 lg:text-[15px]"
            {...register("email", {
              required: true,
            })}
          />
          {errors.email?.message ? (
            <span className="lg:text-s text-status-error flex items-center gap-1 md:text-xs">
              <Info className="stroke-errr mb-[1px] h-4 w-4" />
              {errors.email.message}
            </span>
          ) : (
            <span className="lg:text-s text-gray-400 md:text-xs">
        ...
        <div className="flex w-full flex-col gap-1">
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              color="black"
              size="lg"
              className="md:text-s font-semibold md:h-9 md:w-[92px] md:font-medium lg:h-12 lg:w-[100px] lg:text-[15px]"
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex grow">
            <input
              ...
              className="md:text-s w-full pr-12 lg:text-[15px]"
              {...register("authNumber")}
            />
            {isAuthSubmitted && (
          ...
          <Button
            ...
            color="black"
            size="lg"
            className="md:text-s text-[15px] font-semibold md:h-9 md:w-[92px] md:font-medium lg:h-12 lg:w-[100px]"
        ...
        <div className="flex w-full flex-col gap-6 rounded-[10px] border border-gray-600 p-4 md:h-[212px] lg:h-[177px]">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <span className="font-regular md:text-s text-gray-0 lg:text-sm">
              개인정보 수집을 동의합니다 (필수)
            </span>
          </div>
        </div>
        <Button
          ...
          color="primary"
          size="lg"
          className="w-full md:mt-6 md:mb-6 lg:mt-8"
