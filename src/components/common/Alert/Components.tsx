...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed top-1/2 left-1/2 z-100 flex h-[244px] w-[544px] -translate-x-1/2 -translate-y-1/2 transform flex-col gap-8 rounded-[30px] bg-white p-8",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(
      buttonVariants({ variant: "default", color: "primary", size: "lg" }),
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={cn(
      buttonVariants({ variant: "default", color: "grey", size: "lg" }),
      className
    )}
    {...props}
  />
