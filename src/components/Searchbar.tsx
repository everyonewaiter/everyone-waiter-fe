...
export default function Searchbar({
  ...
  return (
    <div className="flex h-8 w-full items-center justify-between rounded-3xl border border-gray-600 bg-gray-700 px-4 md:mx-0 md:w-70 md:px-4 lg:ml-5 lg:h-[46px]">
      <input
